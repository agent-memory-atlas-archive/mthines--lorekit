...
| [key-files.md](./key-files.md) | Developers | Annotated file index (~152 files) — the full-detail version of the CLAUDE.md "Key files" pointer |
| [cli.md](./cli.md) | Developers | `@lorekit/cli` command reference (install/doctor/update/read commands/hook/mcp) |
